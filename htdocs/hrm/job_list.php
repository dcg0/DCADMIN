...
$sql .= ", COUNT(ju.rowid) as nbofskills";
...
$sql .= " LEFT JOIN ".$db->prefix()."hrm_job_user as ju ON ju.fk_job = t.rowid";
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/hrm/job_card.php', 1).'?id='.((int) $id));
	exit;
}
...
llxHeader('', $title, $help_url, '', 0, 0, $morejs, $morecss, '', 'mod-hrm page-list bodyforlist');
...
print '<th class="liste_titre right">'.$langs->trans("NbOfExpectedSkills").'</th>';
$totalarray['nbfield']++;
...
while ($i < $imaxinloop) {
	...
	if ($mode == 'kanban') {
		...
		print '<td class="right">'.$obj->nbofskills.'</td>';
