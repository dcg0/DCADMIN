...
dol_include_once('/debugbar/class/DataCollector/DCADMINCollector.php');
...
class DCADMINDebugBar extends DebugBar
{
	...
	public function __construct()
	{
		...
		$this->addCollector(new DCADMINCollector());
