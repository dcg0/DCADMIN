 ...
 */
class Workstations extends DCADMINApi
{
	/**
	...
	public function index($sortfield = "t.ref", $sortorder = 'ASC', $limit = 100, $page = 0, $sqlfilters = '', $properties = '')
	{
		...
		if (!DCADMINApiAccess::$user->hasRight('workstation', 'workstation', 'read')) {
	...
	private function _fetch($id, $ref = '')
	{
		...
		if (!DCADMINApi::_checkAccessToResource('workstation', $this->workstation->id)) {
