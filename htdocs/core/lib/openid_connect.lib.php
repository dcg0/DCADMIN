 ...
 *
 * Checks that the state was generated by this DCADMIN instance by recomputing
...
/**
 * Create a DCADMIN user from OIDC userinfo claims.
 *
 * The login is sanitized to remove characters not allowed by DCADMIN (e.g. @ from emails).
...
function openid_connect_create_user($db, $userinfo, $login, $entity)
{
	...
	// Sanitize login using DCADMIN forbidden characters for logins.
