 ...
 *  \brief      Module to manage data exports from DCADMIN database
 *
 ...
 */
class modExport extends DCADMINModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->description = "Outils d'exports de donnees DCADMIN (via un assistant)";
