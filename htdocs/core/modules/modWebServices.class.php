 ...
 *      \brief      Module to enable the DCADMIN server of web services
 ...
 */
class modWebServices extends DCADMINModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->description = "Enable the DCADMIN web services server";
