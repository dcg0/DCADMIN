 ...
 *	\brief      Class file to manage DCADMIN database access for a SQLite database
 */

require_once DOL_DOCUMENT_ROOT.'/core/db/DoliDB.class.php';

/**
 *	Class to manage DCADMIN database access for a SQLite database
 */
class DoliDBSqlite3 extends DoliDB
{
	 ...
	 *
	 * @param   string	$tab    	Table name concerned by insert. Not used for mysql, but required for Postgresql
