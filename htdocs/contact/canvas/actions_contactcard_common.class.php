	...
	public function assign_values(&$action, $id, $ref = '')
	{
		...
		if ($action == 'view' || $action == 'edit' || $action == 'delete') {
			...
			if ($this->object->user_id) {
				...
				$this->tpl['dolibarr_user'] = $langs->trans("NoDCADMINAccess");
			}
		}
		...
		if ($action == 'create_user') {
			...
			$this->tpl['action_create_user'] = $form->formconfirm($_SERVER["PHP_SELF"]."?id=".$this->object->id, $langs->trans("CreateDCADMINLogin"), $langs->trans("ConfirmCreateContact"), "confirm_create_user", $formquestion, 'no');
		}
	}
