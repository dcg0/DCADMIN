 ...
 */
class Warehouses extends DCADMINApi
{
	/**
	...
	public function get($id)
	{
		...
		if (!DCADMINApi::_checkAccessToResource('stock', $this->warehouse->id, 'entrepot')) {
	...
	public function post($request_data = null)
	{
		...
		if ($this->warehouse->create(DCADMINApiAccess::$user) < 0) {
	...
	public function put($id, $request_data = null)
	{
		...
		$updateresult = $this->warehouse->update($id, DCADMINApiAccess::$user);
		if ($updateresult > 0) {
			return $this->get($id);
		} else {
	...
	public function delete($id)
	{
		...
		if (!$this->warehouse->delete(DCADMINApiAccess::$user)) {
