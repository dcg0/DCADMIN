...
if ($id > 0 || !empty($ref)) {
	$upload_dir = (!empty($conf->stocktransfer->multidir_output[$object->entity ?? $conf->entity]) ? $conf->stocktransfer->multidir_output[$object->entity ?? $conf->entity] : $conf->stocktransfer->dir_output)."/".$object->id;
}
