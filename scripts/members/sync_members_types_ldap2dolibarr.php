 ...
 * \ingroup ldap member
 * \brief 	Script to update members types into DCADMIN from LDAP
 */
...
if (!getDolGlobalString('LDAP_MEMBER_TYPE_DN')) {
	print $langs->trans("Error").': '.$langs->trans("LDAP setup for members types not defined inside DCADMIN");
	exit(1);
}
